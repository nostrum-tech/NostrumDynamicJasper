CREATE TABLE CUSTOMER(ID INTEGER NOT NULL PRIMARY KEY,FIRSTNAME VARCHAR,LASTNAME VARCHAR,STREET VARCHAR,CITY VARCHAR);
CREATE TABLE PRODUCT(ID INTEGER NOT NULL PRIMARY KEY,NAME VARCHAR,PRICE DECIMAL);
CREATE TABLE INVOICE(ID INTEGER NOT NULL PRIMARY KEY,CUSTOMERID INTEGER,TOTAL DECIMAL,CONSTRAINT SYS_FK_50 FOREIGN KEY(CUSTOMERID) REFERENCES CUSTOMER(ID) ON DELETE CASCADE);
CREATE TABLE ITEM(INVOICEID INTEGER NOT NULL,ITEM INTEGER NOT NULL,PRODUCTID INTEGER,QUANTITY INTEGER,COST DECIMAL,PRIMARY KEY(INVOICEID,ITEM),CONSTRAINT SYS_FK_55 FOREIGN KEY(INVOICEID) REFERENCES INVOICE(ID) ON DELETE CASCADE,CONSTRAINT SYS_FK_56 FOREIGN KEY(PRODUCTID) REFERENCES PRODUCT(ID) ON DELETE CASCADE);
