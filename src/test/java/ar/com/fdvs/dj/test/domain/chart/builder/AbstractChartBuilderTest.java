...
/*		GroupBuilder gb2 = new GroupBuilder();
		...
		final AbstractChartBuilder<?> builder = new DJAreaChartBuilder();
		...
		final DJChart djChart = ((DJAreaChartBuilder)builder)
		//dataset
		...
		final HashMap<AbstractColumn, JRDesignVariable> vars =
			new HashMap<>();
	...
	public static void main(String[] args) throws Exception {
		final AbstractChartBuilderTest test = new AbstractChartBuilderTest();
		test.setUp();
		test.testReport();
