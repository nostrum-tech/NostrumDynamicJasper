...
public class TestMockRepository {
	...
	public static Collection getDummyCollection(){
		...
		col.add(new Product( Long.valueOf("1"),"book","Harry Potter 7","Florida","Main Street", Long.valueOf("2500"), Float.valueOf("5")));
		col.add(new Product( Long.valueOf("1"),"book","Harry Potter 7","Florida","Railway Station", Long.valueOf("1400"), Float.valueOf("10")));
		col.add(new Product( Long.valueOf("1"),"book","Harry Potter 7","Florida","Baseball Stadium", Long.valueOf("4000"), Float.valueOf("5")));
...
//		col.add(new Product( Long.valueOf("1"),"book","Harry Potter 7","New York","Railway Station", Long.valueOf("1400"), Float.valueOf("3322")));
		col.add(new Product( Long.valueOf("1"),"book","Harry Potter 7","New York","Baseball Stadium", Long.valueOf("4000"), Float.valueOf("3")));
		col.add(new Product( Long.valueOf("1"),"book","Harry Potter 7","New York","Shopping Center", Long.valueOf("3000"), Float.valueOf("10")));
...
//		col.add(new Product( Long.valueOf("1"),"book","Harry Potter 7","Arizona","Baseball Stadium", Long.valueOf("3000"), Float.valueOf("78482")));
//		col.add(new Product( Long.valueOf("1"),"book","Harry Potter 7","Arizona","Shopping Center", Long.valueOf("1500"), Float.valueOf("5831.32")));
		col.add(new Product( Long.valueOf("2"),"book","The Sum of All Fears","Florida","Main Street", Long.valueOf("8400"), Float.valueOf("8")));
...
//		col.add(new Product( Long.valueOf("2"),"book","The Sum of All Fears","Arizona","Main Street", Long.valueOf("4000"), Float.valueOf("9482.4")));
//		col.add(new Product( Long.valueOf("2"),"book","The Sum of All Fears","Arizona","Railway Station", Long.valueOf("3000"), Float.valueOf("8329.2")));
//		col.add(new Product( Long.valueOf("2"),"book","The Sum of All Fears","Arizona","Baseball Stadium", Long.valueOf("1500"), Float.valueOf("27475.5")));
//		col.add(new Product( Long.valueOf("2"),"book","The Sum of All Fears","Arizona","Shopping Center", Long.valueOf("8400"), Float.valueOf("3322")));
...
//		col.add(new Product( Long.valueOf("3"),"book","The Pelican Brief,","Arizona","Shopping Center", Long.valueOf("1400"), Float.valueOf("8329.2")));
		col.add(new Product( Long.valueOf("4"),"dvd","Titanic","Florida","Main Street", Long.valueOf("4000"), Float.valueOf("10")));
		col.add(new Product( Long.valueOf("4"),"dvd","Titanic","Florida","Railway Station", Long.valueOf("3000"), Float.valueOf("3")));
//		col.add(new Product( Long.valueOf("4"),"dvd","Titanic","Florida","Baseball Stadium", Long.valueOf("1500"), Float.valueOf("80")));
