...
public class DefaultEncodingReportTest extends BaseDjReportTest {
    ...
    public static Collection getDummyCollection() {
        ...
        col.add(new Product(1L, "book", "ąćęłńóśźż", "abcdefghaijkslmnopqĄĆĘŁŃÓŚŹŻĄĆĘŁŃÓŚŹŻĄĆĘŁŃÓŚŹŻĄĆĘŁŃÓŚŹŻĄĆĘŁŃÓŚŹŻĄĆĘŁ", "Main Street", Long.valueOf("2500"), Float.valueOf("5")));
        col.add(new Product(1L, "book", "áñö", "ĄĆĘŁŃÓŚŹŻ", "Main Street", Long.valueOf("2500"), Float.valueOf("5")));
        return col;
    }
